...
//
//  Created by Jose Omar Colorado Perez on 24/03/17.
...
class RomanNumeralCalculatorUITests: XCTestCase {
    ...
    func testAddOnePlusOne() {
        ...
        let calLabel = app.staticTexts["calculated_value"]
        
        //Tap "I"
        iButton.tap()
        XCTAssertEqual(calLabel.label, "I")
        
        //Tap "+"
        app.buttons["+"].tap()
        //Tap "I"
        iButton.tap()
        XCTAssertEqual(calLabel.label, "II")
